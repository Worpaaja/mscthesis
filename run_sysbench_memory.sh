...
do
	...
	sysbench --threads=4 --time=120 memory --memory-access-mode=seq --memory-oper=write run > benchmark_mem/$dirname/seqw/$i.txt;
done
...
do	
	...
	sysbench --threads=4 --time=120 memory --memory-access-mode=seq --memory-oper=read run > benchmark_mem/$dirname/seqr/$i.txt;
done
...
do
	...
	sysbench --threads=4 --time=120 memory --memory-access-mode=rnd --memory-oper=write run > benchmark_mem/$dirname/randw/$i.txt;
done
...
do
	...
	sysbench --threads=4 --time=120 memory --memory-access-mode=rnd --memory-oper=read run > benchmark_mem/$dirname/randr/$i.txt;
done
