...
do
	...
	#sysbench fileio test ran with sequential read and 4 threads which is the number of threads for used CPU, maximum execution time set at 120s(2 minutes)
	sysbench --threads=4 --time=120 fileio --file-test-mode=seqrd run > benchmark_fileio/$dirname/seqr/$i.txt;
	
	#sysbench fileio test ran with sequential rewrite and 4 threads which is the number of threads for used CPU, maximum execution time set at 120s(2 minutes)
	sysbench --threads=4 --time=120 fileio --file-test-mode=seqrewr run > benchmark_fileio/$dirname/seqrw/$i.txt;
	
	#sysbench fileio test ran with random write and 4 threads which is the number of threads for used CPU, maximum execution time set at 120s(2 minutes)
	sysbench --threads=4 --time=120 fileio --file-test-mode=rndwr run > benchmark_fileio/$dirname/randw/$i.txt;
	
	#sysbench fileio test ran with random read and 4 threads which is the number of threads for used CPU, maximum execution time set at 120s(2 minutes)
	sysbench --threads=4 --time=120 fileio --file-test-mode=rndrd run > benchmark_fileio/$dirname/randr/$i.txt;	
	
		#sysbench fileio test ran with sequential write and 4 threads which is the number of threads for used CPU, maximum execution time set at 120s(2 minutes)
	sysbench --threads=4 --time=120 fileio --file-test-mode=seqwr run > benchmark_fileio/$dirname/seqw/$i.txt;
