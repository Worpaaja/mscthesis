...
echo -e "Function \t Best Rate MB/s \t Avg time \t \t Max Time" >> streambenchmark/summary_$dirname.txt
echo -e "Copy: \t \t "$copy_bestrate" \t \t "$copy_avg_time" \t \t "$copy_max_time"" >> streambenchmark/summary_$dirname.txt
echo -e "Scale: \t \t "$scale_bestrate" \t \t "$scale_avg_time" \t \t "$scale_max_time"" >> streambenchmark/summary_$dirname.txt
echo -e "Add: \t \t "$add_bestrate" \t \t "$add_avg_time" \t \t "$add_max_time"" >> streambenchmark/summary_$dirname.txt
echo -e "Triad: \t \t "$triad_bestrate" \t \t "$triad_avg_time" \t \t "$triad_max_time"" >> streambenchmark/summary_$dirname.txt
